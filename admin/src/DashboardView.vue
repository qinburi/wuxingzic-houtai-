...
@media (max-width: 1450px) { .governance-metrics { grid-template-columns: repeat(3, 1fr); }.governance-lists { grid-template-columns: 1fr 1fr; }.systems-panel { grid-column: 1 / 3; } }
@media (max-width: 1200px) { .governance-charts { grid-template-columns: 1.55fr 1fr; }.department-panel { grid-column: 1 / 3; min-height: 290px; } }
